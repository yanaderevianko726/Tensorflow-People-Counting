...
def main_peoson_count(input_video, detection_graph, category_index, is_color_recognition_enabled, roi, deviation, custom_object_name, targeted_objects):
    total_passed_objects = 0              
          ...
          with tf.Session(graph=detection_graph) as sess:
            ...
            while True:
                ...
                if(len(counting_result) == 0):
                    ...
                    cv2.putText(input_frame, counting_result, (10, 35), font, 0.8, (0,255,255),2,cv2.FONT_HERSHEY_SIMPLEX)                
                print("counting_result %s" %counting_result)
